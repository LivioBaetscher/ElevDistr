...
#'                            pointDf = utils::data("pointsAboveTreeline"), gridSize = 10,
...
distance_to_treeline <- function(lon, lat, gstRaster, gslRaster, elevationRaster, elevation, pointDf = utils::data("pointsAboveTreeline"), gridSize = 10, gridStepSize = 0.0025,
