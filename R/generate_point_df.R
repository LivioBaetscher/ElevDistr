...
#' @param gstRaster Raster layer that contains the growing season temperature. Data type "RasterLayer".
#' @param gslRaster Raster layer that contains the growing season length. Data type "RasterLayer".
...
generate_point_df <- function(gstRaster, gslRaster, stepSize = 0.0416666, gstTreshold = 6.4, gslTreshold = 94) {
  ...
  gstValues <- raster::extract(gstRaster, point)
  gslValues <- raster::extract(gslRaster, point)
